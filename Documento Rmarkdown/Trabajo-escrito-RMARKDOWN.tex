...
\urlstyle{same}
\hypersetup{
  pdftitle={Analisis Exploratorio de Datos ENCSPA-2019- Proyecto Final Estadistica I},
...
rutina se ve similar a la que se despliega en el siguiente botón:

Mostrar/Ocultar Código

\phantomsection\label{section1}
\begin{Shaded}
\begin{Highlighting}[]
