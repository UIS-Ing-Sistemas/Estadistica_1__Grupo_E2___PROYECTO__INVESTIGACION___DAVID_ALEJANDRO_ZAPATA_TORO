...
<button onclick="toggleVisibility(&#39;section1&#39;)" class="custom-button">
...
```{=html}
<script> function toggleVisibility(id) { var element = document.getElementById(id); if (element.style.display === "none") { element.style.display = "block"; } else { element.style.display = "none"; } } </script>
```
...
<button onclick="toggleVisibility(&#39;section2&#39;)" class="custom-button">
...
<button onclick="toggleVisibility(&#39;section3&#39;)" class="custom-button">
...
<button onclick="toggleVisibility(&#39;section4&#39;)" class="custom-button">
...
<button onclick="toggleVisibility(&#39;section5&#39;)" class="custom-button">
...
<button onclick="toggleVisibility(&#39;section6&#39;)" class="custom-button">
...
<button onclick="toggleVisibility(&#39;section7&#39;)" class="custom-button">
...
<button onclick="toggleVisibility(&#39;section8&#39;)" class="custom-button">
...
<button onclick="toggleVisibility(&#39;section9&#39;) " class="custom-button">
