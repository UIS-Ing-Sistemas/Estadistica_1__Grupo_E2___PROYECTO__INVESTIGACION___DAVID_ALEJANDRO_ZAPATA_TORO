...
personas3 <- read_csv("Estadistica_1__Grupo_E2___PROYECTO__INVESTIGACION___DAVID_ALEJANDRO_ZAPATA_TORO/DATOS DANE/Microdatos/d2_capitulos/d2_capitulos.csv")
...
filtrado_personas<-merge(filtrado_personas, personas, by="DIRECTORIO")
write.csv(filtrado_personas, "C:/Users/USUARIO/Documents/ESTADISTICA/PROY_FILTER/DEPARTAMENTOS/filtrado_personas.csv", row.names = FALSE)
View(filtrado_personas)
